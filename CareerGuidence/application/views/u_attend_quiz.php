						...
						<div class="widget-shadow" data-example-id="basic-forms"> 
							...
							$qc_id =$qcid;
							 foreach ($users as $user1) 
								...
								<form action="<?php echo base_url('UserModule/submit_quiz/'.$user1->u_id.'/'.$qc_id) ?>" method="post"> <?php } ?>
							<div class="form-body" id="start">
								...
								foreach ($qid as $row) 
									{ 
										...
										{
											if(($row->q_id) == ($rows->q_id))
											{
											 ?>
											<br>
											<h4><?php echo $rows->q_name; ?></h4>
											<br>
											<input type="radio" name="<?php echo $i; ?>"  value="A" required=""><?php echo $rows->q_option1; ?> <br>
											<input type="radio" name="<?php echo $i; ?>"  value="B" required=""><?php echo $rows->q_option2; ?><br>
											<input type="radio" name="<?php echo $i; ?>"  value="C" required=""><?php echo $rows->q_option3; ?><br>
											<input type="radio" name="<?php echo $i; ?>"  value="D" required=""><?php echo $rows->q_option4; ?><br>
											<input type="hidden" value="<?php echo $rows->q_answer; ?>" name="ans<?php echo $i; ?>" class="form-control"><br>

										<?php 
												$_SESSION['answers'][$i] = $rows->q_answer;
												$count++;
												$i++;
										}
										}
									} ?>
									<input type="hidden" value="<?php echo $count; ?>" name="count" class="form-control">

										<input type="submit" name="submit" class="btn btn-primary" onclick="returnScore()">
