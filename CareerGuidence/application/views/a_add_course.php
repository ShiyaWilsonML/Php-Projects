				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/insert_courses') ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Name</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="name" maxlength="50" minlength="2" placeholder="Eg:- Bsc " required=""> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Stream</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="stream" maxlength="50" minlength="3" placeholder="Eg:- Computer Science" required=""> 
										</div> 
									</div> 
									<div class="form-group"> 
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9">
											<select name="type" class="form-control1" required="">
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
											<select name="dur" class="form-control1" required="">
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
											<input type="text" class="form-control"  name="eligible" placeholder="Eg:- +2 or Equivalent" required=""> 
										</div> 
									</div>
									<!-- <div class="form-group"> 
