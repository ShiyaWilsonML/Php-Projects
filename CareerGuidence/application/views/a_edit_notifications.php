				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/update_notifications/'.$rows->n_id) ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Name</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="name" maxlength="50" minlength="2" placeholder="Eg:- Assistant Public Prosecutor Grade -II " value="<?php echo $rows->n_name; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Department</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="dept" maxlength="50" minlength="10" placeholder="Eg:- Kerala State Assistant Public Prosecutors' Service" value="<?php echo $rows->n_department; ?>"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Category</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="category"  placeholder="Eg:- 326/2017" value="<?php echo $rows->n_category; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Date Time</label> 
										<div class="col-sm-9">
											<input type="datetime-local" class="form-control" name="datetime" maxlength="50" minlength="10" value="<?php echo $rows->n_datetime; ?>" placeholder="Eg:- 	22/01/2019
07.30 AM"> 
										</div> 
									</div>
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
											<textarea name="des" rows="3" style="width: 100%;"><?php echo $rows->n_describe; ?></textarea>
										</div> 
									</div>
