							...
							<tbody> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	...
								  	<td>
										<a class="fa fa-pencil" href="<?php echo base_url('AdminModule/edit_course/'.$coid); ?>"></a>
									</td>
									<td>
										<a class="fa fa-trash" href="<?php echo base_url('AdminModule/delete_course/'.$coid); ?>"></a>
									</td>
									<td>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a align="center" class="fa fa-eye" href="<?php echo base_url('AdminModule/course_tocolleges/'.$coid); ?>"></a>
									</td>
