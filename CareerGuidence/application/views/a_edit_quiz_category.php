					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-title">
								<h4>Edit Quiz Category :</h4>
							</div>
							<div class="form-body">
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/update_quiz_categories/'.$rows->qc_id) ?>" method="post" enctype="multipart/form-data"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Category Name</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="name" id="name" required="" value="<?php echo $rows->qc_name; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Category Duration</label> 
										<div class="col-sm-9">
											<textarea name="des" required="" style="width: 100%;"><?php echo $rows->qc_describe; ?></textarea>
										</div> 
									</div>
