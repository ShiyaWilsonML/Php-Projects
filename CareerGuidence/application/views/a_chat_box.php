				...
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
                    ...
                    <div class="portlet-body chat-widget" >
                    	...
                    	<?php
                    		...
                    		if($rows->chat_from != $aid)	
                    		{ $uid = $rows->chat_from;
                    	?>
                        <div class="container1 darker">
  						<img src="<?php echo base_url() ?>loginindex/images/student.png" alt="Avatar" style="width:100%;">
                        ...
                        <div class="container1">
					  	<img src="<?php echo base_url() ?>loginindex/images/admin.png" alt="Avatar" class="right" style="width:100%;">
						  <p><?php echo $rows->chat_msg ?></p>
...
<div class="portlet-footer">
                        <form role="form" action="<?php echo base_url('AdminModule/sendchat/'.$aid."/".$uid); ?>" method="post">
