				...
				<div class="col-md-4 panel-grids">
					<div class="panel panel-default"> 
						<div class="panel-heading"> 
							<h3><?php echo $rows->c_subject; ?><a style="float: right;" href="<?php echo base_url('AdminModule/delete_contacts/'.$rows->c_id) ?>" class="fa fa-trash"></a></h3>

						</div> 
						<div class="panel-body">
							Name    : <?php echo $rows->c_name; ?><br>
							Email   : <?php echo $rows->c_email; ?><br>
							Phone   : <?php echo $rows->c_phone; ?><br>
							Message : <?php echo $rows->c_msg; ?><br>
						</div> 
					</div>
				</div>
				<?php
