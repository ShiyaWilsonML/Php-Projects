...
<!-- Head -->
<head>
<title>CAREER GURU | Services :: w3layouts</title>
...
<!-- promotions -->
	<section class="wthree-row w3-about  py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="w3ls-title text-uppercase text-center">Courses</h3>
			<div class="card-deck mt-md-5 pt-3">
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g1.jpg" class="img-fluid" alt="Card image cap">
				  ...
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g2.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				  ...
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g3.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				...
				<div class="card-deck mt-md-5 pt-3">
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g4.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
					  <h5 class="card-title">Learn Photoshop.</h5>
					  <p class="card-text mb-3 ">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
				  ...
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g5.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
					  <h5 class="card-title">Learn HTML5.</h5>
					   <p class="card-text mb-3 ">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
				  ...
				  <div class="card">
					<img src="<?php echo base_url() ?>assets/images/g6.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
					  <h5 class="card-title">Learn Node.js.</h5>
					   <p class="card-text mb-3 ">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
