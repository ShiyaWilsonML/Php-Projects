				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<?php $qc_id=$qcid; ?>
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/insert_question/'.$qc_id) ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Question</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="que" id="que" required=""> 
										</div> 
									</div>
									<div class="form-group"> 
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="ans" id="ans" required=""> 
										</div> 
									</div>
