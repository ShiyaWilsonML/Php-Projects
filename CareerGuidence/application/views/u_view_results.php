					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow" data-example-id="basic-forms">
							<div class="form-title" id="hide">
								<h4>View Results <a href="view_graph" style="float: right">View graph</a></h4>
								...
								foreach ($result as $row1) 
									...
									{ 
										if($row1->qc_id == $row2->qc_id)
											...
											<tr>
											<td>
											<h4><?php echo $row2->qc_name; ?></h4></td>
											<td>
											<h5><?php echo $row1->qr_questions; ?></h5>
											</td>
											<td>
											<h5><?php echo $row1->qr_answers; ?></h5>
											</td>
											<td><a class="fa fa-eye" href="<?php echo base_url('UserModule/view_course_qcat/'.$row2->qc_id); ?>"></td>
											</tr>
										<?php
											}
										else
