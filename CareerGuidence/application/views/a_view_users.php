						...
						<table class="table table-bordered"> 
							...
							<tbody> 
								...
								<tr> 
									...
									<td><img src="<?php echo base_url('uploads/'.$rows->u_image); ?>" width="60px" height="40px" alt=""></td>
									...
									<td><?php 
										if($rows->u_status=="active")
										{ ?>
											<a class="btn btn-danger" href="<?php echo base_url('AdminModule/user_inactive/'.$rows->u_id); ?>">Inactive</a>

										<?php
										} 
										else
										{ ?>
											<a class="btn btn-success" href="<?php echo base_url('AdminModule/user_active/'.$rows->u_id); ?>">Active</a>
										<?php
										}
									?></td>
									<td><a class="btn btn-primary" href="<?php echo base_url('AdminModule/chat_box/'.$rows->u_id); ?>">View</a></td>
								</tr> 
								<?php 
									}
								?>
