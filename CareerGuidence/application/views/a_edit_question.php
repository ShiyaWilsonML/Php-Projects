					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								...
								?>
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/update_questions/'.$row->q_id) ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Question</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="que" id="que" required="" value="<?php echo $row->q_name; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Option A</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="op1" id="op1" required="" value="<?php echo $row->q_option1; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Option B</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="op2" id="op2" required="" value="<?php echo $row->q_option2; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Option C</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="op3" id="op3" required="" value="<?php echo $row->q_option3; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Option D</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="op4" id="op4" required="" value="<?php echo $row->q_option4; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Correct Answer</label> 
										<div class="col-sm-9">
											<input type="text" class="form-control" name="ans" id="ans" required="" value="<?php echo $row->q_answer; ?>"> 
										</div> 
									</div>
