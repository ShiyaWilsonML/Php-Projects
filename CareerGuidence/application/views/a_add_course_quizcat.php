					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							<div class="form-title">
								<h4><?php
								$qcids = $qcid;
								foreach ($quizcat as $row) {
									$name = $row->qc_name;								}
								 echo $name; ?> :</h4>
							</div>
							<div class="form-body">
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/insert_addquizcourse/'.$qcids) ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Name</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="name" maxlength="50" minlength="2" placeholder="Eg:- Bachelor of Science " value="<?php echo $name; ?>"> 
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Category</label> 
										<div class="col-sm-9">
											<select name="courseid" class="form-control1">
												<option>Select Courses</option>
												<?php
												foreach ($course as $rows) {
													?>
													<option value="<?php echo $rows->co_id; ?>"><?php echo $rows->co_stream; ?></option>
													<?php
												} ?>
											</select>
										</div> 
