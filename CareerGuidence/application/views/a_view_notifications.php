							...
							<tbody> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	...
								  	<td><?php echo $rows->n_department; ?></td>
								  	<td><?php echo $rows->n_category; ?></td>
								  	<td><?php echo $rows->n_datetime; ?></td>
								  	<td><?php echo $rows->n_describe; ?></td>
								  	<td>
										<a class="fa fa-pencil" href="<?php echo base_url('AdminModule/edit_notifications/'.$nid); ?>"></a>
									</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="fa fa-trash" href="<?php echo base_url('AdminModule/delete_notifications/'.$nid); ?>"></a>
									</td>
								<?php 
									}
								?>
