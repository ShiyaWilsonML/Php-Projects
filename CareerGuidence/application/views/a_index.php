      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/change_pwd') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/profile.jpg" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_users') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/users.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_quiz_categories') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/quiz.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_courses') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/course.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_colleges') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/college.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_notifications') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/notify.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_videos') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/video.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_ebooks') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/ebook.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/view_contacts') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/contact.png" width="100%" height="120px">
								<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('AdminModule/logout') ?>">
							<img src="<?php echo base_url() ?>loginindex/images/logout.png" width="100%" height="120px">
								<div class="overlay">
