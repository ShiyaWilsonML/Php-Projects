				...
				<div class="col-md-4 panel-grids">
					<div class="panel panel-default"> 
						<div class="panel-heading"> 
							<h3><?php echo $rows->v_describe; ?> <a style="float: right;" href="<?php echo base_url('AdminModule/delete_videos/'.$rows->v_id) ?>" class="fa fa-trash"></a></h3>

						</div> 
						<div class="panel-body">
							<video width="100%" height="250px" controls>
  							<source src="<?php echo base_url('videos/'.$rows->v_video); ?>" type="video/mp4">
