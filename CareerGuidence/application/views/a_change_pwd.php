							...
							<div class="form-body">
								<form class="form-horizontal" onsubmit="changepassword()" method="post" enctype="multipart/form-data"> 
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9"> <input type="password" class="form-control" id="opwd" name="opwd"  maxlength="10" minlength="6"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">New Password</label> 
										<div class="col-sm-9"> <input type="password" class="form-control" id="npwd" name="npwd" maxlength="10" minlength="6" > 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Confirm Password</label> 
										<div class="col-sm-9"> 
											<input type="password" class="form-control" id="cpwd" name="cpwd" maxlength="10" minlength="6">  
										</div> 
									</div>
   ...
   <script type="text/javascript">
   	function changepassword()
	{
 		 ...
 		 if(opwd!='' && npwd!='' && cpwd!= '')
  		{
            ...
            type: "POST",
            data: data,
            url: baseurl + "AdminModule/check_old_pwd",
            dataType: 'json',
                ...
                if (result) {
                  data = {
                    ...
                    $.ajax({
                      type: "POST",
                      data: data,
                      url: baseurl + "AdminModule/pwd_change",
                      dataType: 'json',
                      success: function(result) {                
                          if (result) {
                              $("#opwd").val('');
