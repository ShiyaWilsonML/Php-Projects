				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<?php
								foreach ($college as $rows) {
									
							?>
							<div class="form-body">
								<form class="form-horizontal" action="<?php echo base_url('AdminModule/update_college/'.$rows->ce_id); ?>" method="post"> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Name</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" name="name" maxlength="50" minlength="10" placeholder="Eg:- St. Mary's College" value="<?php echo $rows->ce_name; ?>"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Ownership</label> 
										<div class="col-sm-9">
											<select name="owner" class="form-control1">
											<?php
												if(($rows->ce_ownership) == "Private")
												{
											?>
											...
											<?php 
												...
												else if(($rows->ce_ownership) == "Aided")
												{
											?>
												<option value="Private">Private</option>
												<option selected="" value="Aided">Aided</option>
												<option value="Autonomous">Autonomous</option>
												<option value="Government">Government</option>
											<?php
												}
												else if(($rows->ce_ownership) == "Autonomous")
												{
											?>
												<option value="Private">Private</option>
												<option value="Aided">Aided</option>
												<option selected="" value="Autonomous">Autonomous</option>
												<option value="Government">Government</option>
											<?php
												}
												else
									...
									<div class="form-group"> 
										...
										<div class="col-sm-9">
											<select name="type" class="form-control1">
												<?php
												if(($rows->ce_type) == "Womens Colleges")
												{
											?>
												<option selected="" value="Womens Colleges">Womens Colleges</option>
												<option value="Boys Colleges">Boys Colleges</option>
												<option value="Mixed Colleges">Mixed Colleges</option>
											<?php 
												}
												else if(($rows->ce_type) == "Boys Colleges")
												{
											?>
												<option value="Womens Colleges">Womens Colleges</option>
												<option selected="" value="Boys Colleges">Boys Colleges</option>
												<option value="Mixed Colleges">Mixed Colleges</option>
											<?php
												}
												else
											...
											?>
												<option value="Womens Colleges">Womens Colleges</option>
												<option value="Boys Colleges">Boys Colleges</option>
												<option selected="" value="Mixed Colleges">Mixed Colleges</option>
											<?php } ?>
											</select>
										</div> 
									</div>
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
											<input type="text" class="form-control"name="university" maxlength="20" minlength="5" placeholder="Eg:- Calicut" value="<?php echo $rows->ce_university; ?>"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Phone</label> 
										<div class="col-sm-9"> 
											<input type="number" class="form-control" id="phone" name="phone" maxlength="10" minlength="10" placeholder="Eg:- 7485964758" value="<?php echo $rows->ce_phone; ?>"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Address</label> 
										<div class="col-sm-9"> 
											<textarea style="width: 100%;" id="address" name="address"><?php echo $rows->ce_address; ?></textarea>
										</div> 
									</div>
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Location</label> 
										<div class="col-sm-9"> 
											<input type="text" class="form-control" id="loc"  name="loc" placeholder="Thrissur" value="<?php echo $rows->ce_location; ?>"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label  class="col-sm-2 control-label">Url</label> 
										<div class="col-sm-9"> 
											<input type="url" name="url" class="form-control" placeholder="Eg:- info@stmaryscollegethrissur.edu.in " value="<?php echo $rows->ce_url; ?>">
										</div> 
									</div> 
									<div class="form-group"> 
										...
										<div class="col-sm-9"> 
											...
											<?php
												...
												else if(($rows->ce_ratings) == "4")
												{
													?>
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3">3</option>
												<option selected="" value="2">4</option>
												<option value="3">5</option>
											<?php } 
											else
												{
