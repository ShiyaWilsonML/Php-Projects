		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('UserModule/view_profile') ?>">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('UserModule/start_quiz/'.$uid) ?>">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="<?php echo base_url('UserModule/chat_box/'.$uid) ?>">
							<img src="<?php echo base_url() ?>loginindex/images/chat.png" width="100%" height="120px">
							<div class="overlay">
								<div class="text">Chatbox</div>
								</div>
						</a>
						</div> 
					</div>
