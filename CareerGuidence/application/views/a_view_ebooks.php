...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">View Ebooks</h2>
				<?php
					foreach ($ebook as $rows) {
				?>
				<div class="col-md-4 panel-grids">
					<div class="panel panel-default"> 
						<div class="panel-heading"> 
							<h4><?php echo $rows->e_name; ?>
								<a style="float: right;" href="<?php echo base_url('AdminModule/delete_ebooks/'.$rows->e_id) ?>" class="fa fa-trash"></a>
							</h4>
							<h6><?php echo $rows->e_author; ?></h6>
						</div> 
						<div class="panel-body">
							<img src="<?php echo base_url('ebooks/'.$rows->e_image); ?>" width="100%" height="200px">
							<a href="<?php echo base_url('ebooks/'.$rows->e_book); ?>"><?php echo $rows->e_name; ?>.pdf</a>
						</div> 
					</div>
				</div>
				<?php
