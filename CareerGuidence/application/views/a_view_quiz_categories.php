							...
							<tbody> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	<td><?php echo $rows->qc_name; ?></td>
								  	<td><?php echo $rows->qc_describe; ?></td>
								  	<td>
										<a class="fa fa-pencil" href="<?php echo base_url('AdminModule/edit_quiz_categories/'.$qcid); ?>"></a>
									</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="fa fa-trash" href="<?php echo base_url('AdminModule/delete_quiz_categories/'.$qcid); ?>"></a>
									</td>
								  	<td>
										<a class="fa fa-plus" href="<?php echo base_url('AdminModule/add_question/'.$qcid); ?>"></a>
									</td>
									<td>
										<a class="fa fa-eye" href="<?php echo base_url('AdminModule/view_question/'.$qcid); ?>"></a>
									</td>
									<td>
										<a class="fa fa-plus" href="<?php echo base_url('AdminModule/add_course_qcat/'.$qcid); ?>"></a>
									</td>
									<td>
										<a class="fa fa-eye" href="<?php echo base_url('AdminModule/view_course_qcat/'.$qcid); ?>"></a>
									</td>
								<?php 
									}
								?>
