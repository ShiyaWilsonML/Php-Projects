							...
							<tbody> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	...
								  	<td><?php echo $rows->q_option1; ?></td>
								  	<td><?php echo $rows->q_option2; ?></td>
								  	<td><?php echo $rows->q_option3; ?></td>
								  	<td><?php echo $rows->q_option4; ?></td>
								  	<td><?php echo $rows->q_answer; ?></td>
								  	<td>
										<a class="fa fa-pencil" href="<?php echo base_url('AdminModule/edit_questions/'.$rows->q_id); ?>"></a>
									</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="fa fa-trash" href="<?php echo base_url('AdminModule/delete_questions/'.$rows->q_id); ?>"></a>
									</td>
								<?php 
											}
										}
