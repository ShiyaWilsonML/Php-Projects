							...
							<tbody> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	...
								  	<td><?php echo $rows->ce_ownership; ?></td>
								  	<td><?php echo $rows->ce_type; ?></td>
								  	<td><?php echo $rows->ce_university; ?></td>
									<td><?php echo $rows->ce_phone; ?></td>
									<td><?php echo $rows->ce_address; ?></td>
									<td><?php echo $rows->ce_location; ?></td>
									<td><?php echo $rows->ce_ratings; ?></td>
									<td>
											<a class="fa fa-edit" href="<?php echo base_url('AdminModule/course_add/'.$rows->ce_id); ?>"></a>
										</td>
										<td>
											<a class="fa fa-eye" href="<?php echo base_url('AdminModule/college_tocourses/'.$rows->ce_id); ?>"></a>
										</td>
										<td>
											<a class="fa fa-pencil" href="<?php echo base_url('AdminModule/edit_college/'.$rows->ce_id); ?>"></a>
										</td>
									<td><?php 
										if($rows->ce_status=="allow")
										{ ?>
											<a class="btn btn-danger" href="<?php echo base_url('AdminModule/college_block/'.$rows->ce_id); ?>">Block</a>

										<?php
										} 
										else
										{ ?>
											<a class="btn btn-success" href="<?php echo base_url('AdminModule/college_allow/'.$rows->ce_id); ?>">Allow</a>
										<?php
										}?>
