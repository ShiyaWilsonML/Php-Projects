		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="row mail_grid_w3l mt-md-5 pt-3">
					...
					<div class="col-md-12 contact_left_grid">
						...
						<div class="contact-fields-w3ls">
							<input type="password" name="pwd" placeholder="Password" required="" min="6" max="13">
						</div>
						<div class="contact-fields-w3ls">
							<input type="submit" value="Submit" name="usignin">
						</div>
						<h4><a href="u_signup.php">Create Account</a></h4>
					</div>
					<?php
...
if (isset($_POST['usignin']))
{
	...
	$sqls = "select * from user_details where u_email='$email' and u_pwd='$pwd' and u_status='$s'";
	...
	{ 
		...
		echo "<script>window.location.href='u_index.php'</script>";
	}
	else
	{
