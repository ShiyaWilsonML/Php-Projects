...
<?php include('a_header.php'); ?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Feedbacks & Complaints</h2>
		<?php 
			$users = 0;
				...
				<div class="col-md-4 panel-grids">
					<div class="panel panel-default"> 
						<div class="panel-heading"> 
							<h3><?php echo $feed[3]; ?><a style="float: right;" href="a_delete_feed.php?id=<?php echo $feed[0];?>" class="fa fa-trash"></a></h3>
						</div> 
						<div class="panel-body">
							<?php echo "<b>Name</b>: "; echo $feed[1]; ?><br>
							<?php echo "<b>Email</b>: "; echo $feed[2]; ?><br>
							<?php echo "<b>Subject</b>: "; echo $feed[3]; ?><br>
							<?php echo "<b>Message</b>: "; echo $feed[4]; ?>
							</video>
						</div> 
					</div>
				</div>
