		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="row mail_grid_w3l mt-md-5 pt-3">
					...
					<div class="col-md-6 contact_left_grid">
						...
						<div class="contact-fields-w3ls">
							<input type="text" name="phno" pattern="[0-9]{10}" placeholder="Telephone" required="">
						</div>
						<div class="contact-fields-w3ls">
...
if (isset($_POST['submit']))
{
	...
	$sql = "insert into contact_details(c_name,c_email,c_phno,c_sub,c_msg) values('$name','$email','$phno','$sub','$msg')";

	$result = mysqli_query($con,$sql);

	if($result)
	{ ?>
		<script>alert("Successfully Submitted");</script> <?php
	}
	else
	{ ?>
		<script>alert("Submition Failed");</script> <?php
	}
}
