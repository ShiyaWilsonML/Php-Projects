								...
								<form class="form-horizontal" method="post" action=""> 
									...
									<div class="form-group"> 
										...
										<?php 
											...
											?>
										<div class="col-sm-9"> 
											<select class="form-control" name="fcats">
												<?php
												while ($fcat = mysqli_fetch_row($result)) {
												# code...
												$i++; 
												?>
												<option value="<?php echo $fcat[0]; ?>"><?php echo $fcat[1]; ?></option>
												<?php } ?>
											</select>	
										</div> 
									</div> 
									<div class="form-group"> 
										...
										<div class="col-sm-9"> <input type="text" class="form-control" id="name" name="name"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">From</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" id="from" name="from"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">To</label> 
										<div class="col-sm-9"> <input type="text" class="form-control" id="to" name="to"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Depart On</label> 
										<div class="col-sm-9"> <input type="date" class="form-control" id="date" name="date"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Departure Time</label> 
										<div class="col-sm-9"> <input type="time" class="form-control" id="dtime" name="dtime"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Arrival Time</label> 
										<div class="col-sm-9"> <input type="time" class="form-control" id="atime" name="atime"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Duration</label> 
										<div class="col-sm-9"> <input type="hours" class="form-control" id="dur" name="dur"  maxlength="25"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Adult</label> 
										<div class="col-sm-9"> <input type="number" class="form-control" id="adults" name="adults"  maxlength="8"> 
										</div> 
									</div> 
									<div class="form-group"> 
										<label class="col-sm-2 control-label">Children</label> 
										<div class="col-sm-9"> <input type="number" class="form-control" id="child" name="child"  maxlength="8"> 
										</div> 
									</div> 
									<div class="col-sm-offset-2"> 
										<input type="submit" class="btn btn-success" value="Add" name="aflight">
									</div> 
								</form> 
							</div>
						</div>
							...
							<tbody id="myTable"> 
								...
								<tr> 
									<th scope="row"><?php echo $i; ?></th> 
								  	...
								  	<td><a href="a_delete_flight.php?id=<?php echo $fdet[0];?>" class="fa fa-trash"></a></td>
								</tr> 
								<?php 
									} }
								?>
...
if (isset($_POST['aflight']))
{
	...
	echo $sql = "insert into flight_details(fc_id,fl_name,fl_from,fl_to,fl_date,fl_dtime,fl_atime,fl_dur,fl_adult,fl_child) values('$fcat','$name','$from','$to','$date','$dtime','$atime','$dur','$adults','$child')";
