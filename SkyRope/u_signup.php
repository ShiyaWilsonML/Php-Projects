...
<!-- contact -->
	<section class="contact-innpage py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="w3ls-title text-uppercase text-center">Register Here</h3>
			<form action="" method="post">
			<div class="row mail_grid_w3l mt-md-5 pt-3">
				
					<div class="col-md-6 contact_left_grid">
						<div class="contact-fields-w3ls">
							<input type="text" name="name" placeholder="Name" required="" max="30">
						</div>
						<div class="contact-fields-w3ls">
							<input type="email" name="email" placeholder="Email" required="" max="40">
						</div>
						<div class="contact-fields-w3ls">
							<input type="password" name="pwd" placeholder="Password" required="" max="13" min="6">
						</div>
						<div class="contact-fields-w3ls">
							<input type="text" name="phno" pattern="[0-9]{10}" placeholder="Phone" required="">
						</div>
					</div>
					<div class="col-md-6 contact_left_grid rgt_gd">
						<div class="contact-fields-w3ls">
							<textarea name="addr" placeholder="Address..." required="" row="1" max="200"></textarea>
						</div>
						<div class="contact-fields-w3ls">
							<input type="text" name="city" placeholder="City" required="" max="30">
						</div>
...
if (isset($_POST['signup']))
{
	...
	$sql = "insert into user_details(u_name,u_email,u_pwd,u_phno,u_addr,u_city,u_status) values('$name','$email','$pwd','$phno','$addr','$city','$status')";
