						...
						<table class="table table-bordered"> 
							...
							<tbody> 
								<?php 
									...
									$book = 0;
									$flight = 0;
									$sql2 = "select * from book_details where u_id='$uid' and fb_status='1'";
									$result1 = mysqli_query($con,$sql2);
									$i= 0;
									while ($book = mysqli_fetch_row($result1)) {
										# code...
										$flid = $book[2];
										...
										while ($flight = mysqli_fetch_row($results)) {
								...
								<tr> 
									...
									<td><?php echo $flight[2]; ?></td>
								  	...
								  	<td><?php echo $flight[4]; ?></td>
									<td><?php echo $book[3]; ?></td>
									<td><?php echo $book[4]; ?></td>
									<td>Rs : <?php echo $book[5]; ?></td>
								</tr> 
								<?php 
									} }
								?>
