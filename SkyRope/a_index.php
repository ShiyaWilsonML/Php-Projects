		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="a_change_pwd.php">
							<img src="loginindex/images/profile.jpg" width="100%" height="120px">
							<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="a_add_flights.php">
							<img src="loginindex/images/flight.png" width="100%" height="120px">
							<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							...
							<img src="loginindex/images/chat.png" width="100%" height="120px">
							<div class="overlay">
				...
				<div class="col-md-2 panel-grids">
					<div class="panel panel-default">
						<div class="panel-body" id="container">
							<a href="a_logout.php">
							<img src="loginindex/images/logout.png" width="100%" height="120px">
								<div class="overlay">
